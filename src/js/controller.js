...
const showRecipe = async () => {
  try {
    ...
    recipe = { // Creating a new object to format under_score_case to camelCase.
      id: recipe.id,
      title: recipe.title,
...
['hashchange', 'load'].forEach(ev => window.addEventListener(ev, showRecipe)) // Using for each to trigger functions.